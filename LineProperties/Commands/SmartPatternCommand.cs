...
[assembly: CommandClass(typeof(LineProperties.Commands.SmartPatternCommand))]

namespace LineProperties.Commands;

public class SmartPatternCommand
{
    [CommandMethod("SMARTPATTERN", CommandFlags.Modal)]
    public void SmartPattern()
    {
        var doc = Application.DocumentManager.MdiActiveDocument;
        var db = doc.Database;
        var ed = doc.Editor;

        var optionsDialog = new SmartPatternOptionsDialog();
